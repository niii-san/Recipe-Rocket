...
function AreaCard({ area }: { area: Area }) {
  return (
    <>
      <div className="w-[300px]  bg-Second text-Text py-2   flex justify-between pl-5 pr-2 rounded-xl cursor-pointer  transition duration-500 ease-in-out transform scale-100  hover:scale-110  ">
